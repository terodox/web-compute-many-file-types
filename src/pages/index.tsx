        ...
        <div className={styles.grid}>
          ...
          >
            <h2 className={inter.className}>
              Large Images <span>-&gt;</span>
            </h2>
            <p className={inter.className}>Demonstrate large image loading</p>
          </a>
          ...
          >
            <h2 className={inter.className}>
              Many Files Types Demo <span>-&gt;</span>
            </h2>
            <p className={inter.className}>Demonstrate different file types loading</p>
          </a>
